  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <MetricCard label="Commission Earned" value={`₹${(totalCommission / 1000).toFixed(1)}K`} sub={`Avg ${(totalCommission / totalGMV * 100).toFixed(1)}%`} icon={<CreditCard className="h-5 w-5" />} trend="neutral" />
